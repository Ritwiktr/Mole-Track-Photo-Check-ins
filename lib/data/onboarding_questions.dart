...
const onboardingQuestions = <OnboardingQuestion>[
  OnboardingQuestion(
    id: 'concern',
    prompt: 'What is your biggest skincare concern right now?',
    ...
    options: [
      ...
      'Oil control and pores',
      'Preventive routine building',
    ],
  ),
  OnboardingQuestion(
    id: 'duration',
    prompt: 'How long have you been following a skincare routine?',
  ...
  OnboardingQuestion(
    id: 'rx',
    prompt: 'Do you consult a skincare professional regularly?',
  ...
  OnboardingQuestion(
    ...
    subtitle: 'Changes help us tune product pacing and check-ins.',
    type: QuestionType.singleChoice,
  ...
  OnboardingQuestion(
    ...
    options: [
      ...
      'Prepare for a professional consultation',
    ],
  ),
  OnboardingQuestion(
    id: 'sensitivity',
