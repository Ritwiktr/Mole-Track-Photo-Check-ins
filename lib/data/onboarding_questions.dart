...
const onboardingQuestions = <OnboardingQuestion>[
  OnboardingQuestion(
    id: 'concern',
    prompt: 'What worries you most about your moles right now?',
    subtitle: 'We use this to prioritize your plan.',
    type: QuestionType.singleChoice,
    options: [
      'A new or changing spot',
      'Many moles / hard to track',
      'Sun exposure & prevention',
      'Cosmetic appearance',
      'Mostly preventive check-ins',
    ],
  ),
  OnboardingQuestion(
    id: 'duration',
    prompt: 'How long have you been monitoring your moles?',
  ...
  OnboardingQuestion(
    id: 'routine',
    prompt: 'How do you document spots today?',
    subtitle: 'No judgment — we meet you where you are.',
    type: QuestionType.singleChoice,
    options: [
      'Photos in my camera roll only',
      'Notes or a calendar reminder',
      'Dermatologist photos / mapping',
      'I am starting from scratch',
    ],
  ),
  OnboardingQuestion(
    id: 'rx',
    prompt: 'Do you see a dermatologist for mole checks?',
    subtitle: 'So we align reminders with professional care.',
    type: QuestionType.singleChoice,
  ...
  OnboardingQuestion(
    id: 'dairy',
    prompt: 'Family history of melanoma or many atypical moles?',
    subtitle: 'Optional context for how cautious suggestions should read.',
    type: QuestionType.singleChoice,
  ...
  OnboardingQuestion(
    ...
    subtitle: 'UV exposure matters for mole monitoring.',
    type: QuestionType.singleChoice,
    options: [
      'Mostly indoors',
  ...
  OnboardingQuestion(
    id: 'hormonal',
    prompt: 'Have any moles changed in the last few months?',
    subtitle: 'Changes are worth steady photo comparisons.',
    type: QuestionType.singleChoice,
    options: ['Yes, I think so', 'Unsure', 'No', 'I have not checked closely'],
  ),
  OnboardingQuestion(
    id: 'goal',
    ...
    type: QuestionType.singleChoice,
    options: [
      'Build a monthly photo habit',
      'Track a few specific spots',
